...
This repo aims to share resources for building Traditional-Chinese instruction-following language models (for research purposes only). This repo contains:
  ...
  - Code for [training](#training) and [inferencing](#inferencing) the Traditional-Chinese Alpaca-Lora LLaMA model.

Following are some good examples generated by the Traditional-Chinese Alpaca-Lora LLaMA model.
